  ...
  return (
    ...
    >
      <Card className="h-full overflow-hidden hover:shadow-2xl transition-all duration-500 group border-0 shadow-lg bg-white">
        ...
        <div className="aspect-[4/3] relative overflow-hidden bg-gradient-to-br from-blue-50 to-indigo-100">
          <Image
        ...
        <CardContent className="p-6 space-y-4"> 
          ...
          <p className="text-gray-600 text-sm leading-relaxed line-clamp-2">
            {service.description ||
              t("Professional medical service with trained attendants providing quality care and support")}
          </p>
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              <div className="space-y-1">
                ...
                <p className="text-sm text-gray-500">{service.price > 0 ? t("One-time payment") : t("Per day rental")}</p>
              </div>
            </div>
