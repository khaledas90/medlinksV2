      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12 animate-fade-in-up">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            {t(
              "Explore our wide range of medical equipment available for sale and rent"
            )}
          </p>
        </div>
        ...
        <Tabs defaultValue="for-sale" className="w-full">
          <TabsList className="grid w-full grid-cols-2 max-w-md mx-auto mb-8">
            <TabsTrigger className="cursor-pointer" value="for-sale">
              {t("Categories for Sale")}
            </TabsTrigger>
            <TabsTrigger className="cursor-pointer" value="for-rent">
              {t("Categories for Rent")}
            </TabsTrigger>
          </TabsList>
