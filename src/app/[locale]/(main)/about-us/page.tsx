...
export const metadata: Metadata = {
  title: "About Us | MedLinks",
  description:
    "Learn more about MedLinks – your trusted partner in medical equipment, rentals, hospital services, and doctor appointment bookings in the UAE.",
  keywords: [
    "About MedLinks",
  ...
  openGraph: {
    title: "About Us | MedLinks",
    description:
      "Trusted name for medical rentals and healthcare services in the UAE.",
    url: "https://mymedlinks.com/en/about-us",
    images: [
      {
        url: "https://mymedlinks.com/og/about.jpg",
        width: 1200,
        height: 630,
        alt: "MedLinks About",
      },
